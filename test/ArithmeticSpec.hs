...
spec :: Spec
spec = do
    describe "P31. Check whether a number is prime" $ do
        it "Zero should not be prime" $ do
            isPrime 0 `shouldBe` False

        it "One should not be prime" $ do
            isPrime 1 `shouldBe` False

        it "Two should be prime" $ do
            isPrime 2 `shouldBe` True
        
        it "Twelve should not be prime" $ do
            isPrime 12 `shouldBe` False
            
        it "Thirteen should be prime" $ do
            isPrime 13 `shouldBe` True

    describe "P32. Find the greatest common divisor of two numbers" $ do
    ...
    describe "P33. Check whether two numbers are coprimes" $ do
    ...
    describe "P34. Count coprime numbers; Euler's totient" $ do
        -- 10 : 1, 3, 7, 9
    ...
    describe "P35. Find prime factors" $ do
        it "5 should be [5]" $ do
    ...
    describe "P36. Find frequency of prime numbers" $ do
        it "5 should be [5]" $ do
    ...
    describe "P37. Count coprime numbers" $ do
        -- 10 : 1, 3, 7, 9
        it "10 should have 4 coprimes" $ do
    ...
    describe "P39. Build a list of prime numbers" $ do
    ...
    describe "P40. Goldbach's conjecture" $ do
    ...
    describe "P41. Build Goldbach lists for a range" $ do
